...
export default function About() {
    return (
        <section className='About'>
            <Heading
                svg={<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill='currentColor' viewBox="0 0 512 512" xmlSpace="preserve"><path d="M473.61 63.16L276.16 2.927C269.788.986 263.004 0 256.001 0c-7.005 0-13.789.986-20.161 2.927L38.386 63.16c-3.457 1.064-5.689 3.509-5.689 6.25 0 2.74 2.232 5.186 5.691 6.25l91.401 27.88v77.228c.023 39.93 13.598 78.284 38.224 107.981 11.834 14.254 25.454 25.574 40.483 33.633 15.941 8.564 32.469 12.904 49.124 12.904 16.646 0 33.176-4.34 49.126-12.904 22.597-12.143 42.04-31.646 56.226-56.39 14.699-25.683 22.471-55.155 22.478-85.224v-78.214l45.244-13.804v64.192c-6.2.784-11.007 6.095-11.007 12.5a12.563 12.563 0 008.872 12.011l-9.596 63.315a5.495 5.495 0 001.262 4.386 5.489 5.489 0 004.148 1.902h36.273a5.479 5.479 0 005.41-6.296l-9.596-63.307a12.562 12.562 0 008.872-12.011c0-6.405-4.81-11.716-11.011-12.5V81.544l19.292-5.885c3.457-1.064 5.691-3.517 5.691-6.25-.001-2.732-2.235-5.186-5.694-6.249zM257.62 297.871c-10.413 0-20.994-2.842-31.448-8.455-16.194-8.649-30.908-23.564-41.438-42.011-4.854-8.478-8.796-17.702-11.729-27.445 60.877-10.776 98.51-49.379 119.739-80.97 10.242 20.776 27.661 46.754 54.227 58.648-3.121 24.984-13.228 48.812-28.532 67.212-8.616 10.404-18.773 18.898-29.375 24.573-10.458 5.606-21.039 8.448-31.444 8.448z" className="st0"></path><path d="M373.786 314.23l-1.004-.629-110.533 97.274L151.714 313.6l-1.004.629c-36.853 23.036-76.02 85.652-76.02 156.326v.955l.846.45c.755.405 76.892 40.04 186.713 40.04 109.819 0 185.958-39.635 186.712-40.038l.846-.45v-.955c.001-70.676-39.168-133.292-76.021-156.327z" className="st0"></path></svg>}
